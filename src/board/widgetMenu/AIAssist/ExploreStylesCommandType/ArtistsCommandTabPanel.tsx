...
const PREFIX = 'ArtistsCommandTabPanel';
...
/**
 * ArtistsCommandTabPanel component displays a list of custom style commands
 * related to Artists.
 *
 ...
 * @returns {React.ReactNode} The rendered ArtistsCommandTabPanel component.
 */
const ArtistsCommandTabPanel = ({
  ...
  const artistsCommandData = customStyleCommandData
  ...
  return (
    <Root>
      <Box className={classes.imagesCommandBox}>
        {artistsCommandData.map((item, index) => (
          <CommandCard
            key={index}
            item={item}
            index={index}
...
/**
 * CommandCard component renders a card for each command in the ArtistsCommandTabPanel.
 *
 * @param {Object} props - The properties passed to the component.
...
ArtistsCommandTabPanel.propTypes = {
...
export default ArtistsCommandTabPanel;
