...
const PREFIX = 'MediumCommandTabPanel';
...
/**
 * MediumCommandTabPanel component displays a list of custom style commands
 * related to Medium.
 *
 ...
 * @returns {React.ReactNode} The rendered MediumCommandTabPanel component.
 */
const MediumCommandTabPanel = ({
  ...
  const mediumCommandData = customStyleCommandData
  ...
  return (
    <Root>
      <Box className={classes.imagesCommandBox}>
        {mediumCommandData.map((item, index) => (
          <CommandCard
            key={index}
            item={item}
            index={index}
...
/**
 * CommandCard component renders a card for each command in the MediumCommandTabPanel.
 *
 * @param {Object} props - The properties passed to the component.
...
MediumCommandTabPanel.propTypes = {
...
export default MediumCommandTabPanel;
