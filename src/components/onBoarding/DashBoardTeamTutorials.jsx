...
const PREFIX = 'DashBoardTeamTutorials';
...
export default function DashBoardTeamTutorials() {
  //use
  ...
  const tutorialStepsOne =
    localStorage.getItem('dashBoardTeamTutorials') &&
    localStorage.getItem('dashBoardTeamTutorials') === 'true' &&
    tutorialSteps === 0;

  const handleCloseTutorialSteps = () => {
    setTutorialSteps(2);
    localStorage.setItem('dashBoardTeamTutorials', 'false');
  }

  useEffect(() => {
    if(localStorage.getItem('dashBoardInviteTeamTutorials') && localStorage.getItem('dashBoardInviteTeamTutorials') === 'true') {
      setTutorialSteps(1);
      localStorage.setItem('dashBoardInviteTeamTutorials', 'false');
    }
  }, [])
  ...
  return (
    <>
      <StyledPopperOne
        ...
        anchorEl={document.getElementById('id_inviteMembers')}
      >
        <svg
          width="11"
          height="34"
        ...
        <Box>
          <Typography className={classes.tutorialsTitle} variant="h5">
            {t('components.teamTutorial.firstTutorialsTitle')}
          </Typography>
          <Typography className={classes.tutorialsContent}>
            {t('components.teamTutorial.firstTutorialsContent')}
          </Typography>
        </Box>
        <Box className={classes.nextStepsButtonBox}>
          ...
          >
            {t('components.teamTutorial.nextSteps')}
          </Button>
        </Box>
      </StyledPopperOne>
      ...
      <StyledPopperTwo
        ...
        anchorEl={document.getElementById('createRoomIcon')}
      >
        <svg
          width="11"
          height="34"
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          style={{ position: 'absolute', left: smallScreen ?  '3%' :'50%', top: '-30px' }}
        >
          <path
            d="M5.5 33.3333C8.44552 33.3333 10.8333 30.9455 10.8333 28C10.8333 25.0545 8.44552 22.6667 5.5 22.6667C2.55448 22.6667 0.166667 25.0545 0.166667 28C0.166667 30.9455 2.55448 33.3333 5.5 33.3333ZM6.5 28L6.5 -7.90754e-07L4.5 -8.78176e-07L4.5 28L6.5 28Z"
            fill="#F21D6B"
        ...
        <Box>
          <Typography className={classes.tutorialsTitle} variant="h5">
            {t('components.teamTutorial.secondTutorialsTitle')}
          </Typography>
          <Typography className={classes.tutorialsContent}>
            {t('components.teamTutorial.secondTutorialsContentOne')}
            <br />
            <br />
            {t('components.teamTutorial.secondTutorialsContentTwo')}
          </Typography>
        </Box>
        <Box className={classes.nextStepsButtonBox}>
          <Button
          ...
          >
            {t('components.teamTutorial.gotIt')}
          </Button>
        </Box>
      </StyledPopperTwo>
    </>
