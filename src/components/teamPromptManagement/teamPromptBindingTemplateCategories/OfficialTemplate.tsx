...
const OfficialTemplate = props => {
  ...
  return (
    <StyledBox>
      {offTemplateList &&
        (offTemplateList as any).map((item, index) => (
          <TemplatesCard
            key={index}
            item={item}
            index={index}
      ...
      {offTemplateList &&
        (offTemplateList as any).length % 4 === 2 &&
        (offTemplateList as any)
          .slice(0, 2)
          .map((item, index) => (
      ...
      {offTemplateList &&
        (offTemplateList as any).length % 4 === 3 &&
        (offTemplateList as any)
          .slice(0, 2)
          .map((item, index) => (
            <Card classes={{ root: classes.cardRoot2 }} key={index}></Card>
