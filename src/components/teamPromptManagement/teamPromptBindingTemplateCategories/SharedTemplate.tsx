...
const SharedTemplate = props => {
  ...
  return (
    <StyledBox>
      {orgTemplateList &&
        (orgTemplateList as any).map((item, index) => (
          <TemplatesCard
            key={index}
            item={item}
            index={index}
      ...
      {orgTemplateList &&
        (orgTemplateList as any).length % 4 === 2 &&
        (orgTemplateList as any)
          .slice(0, 2)
          .map((item, index) => (
      ...
      {orgTemplateList &&
        (orgTemplateList as any).length % 4 === 3 &&
        (orgTemplateList as any)
          .slice(0, 2)
          .map((item, index) => (
            <Card classes={{ root: classes.cardRoot2 }} key={index}></Card>
